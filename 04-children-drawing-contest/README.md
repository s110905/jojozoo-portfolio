...
*   **數位報名與上傳**：支援家長透過手機直接拍攝畫作並上傳，系統內建圖片壓縮邏輯以優化存取效能。
*   **作品藝廊**：提供美觀的作品展示介面，方便民眾瀏覽所有參賽作品。
*   **階段控管機制**：具備靈活的活動週期管理（上傳期、投票期、已截止），依階段自動切換 UI 功能。
*   **防弊與驗證**：
    *   整合 Google 登入驗證身分。
    *   實作「一帳號限一作品」與「姓名重複檢查」邏輯，確保比賽公平性。
*   **即時通知**：整合 Webhook 系統，當有新作品提交時即時通知管理團隊進行審核。
