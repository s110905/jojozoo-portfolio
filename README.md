...
### 10. [加入 LINE 參加抽抽樂：好友裂變導客系統](./10-line-lucky-draw) (🌐 [線上展示](https://lineluckydraw-99cutezoo.web.app))
*   **行銷價值**: 以「加入官方帳號好友」為抽獎門檻，把一次性活動流量沉澱為可再行銷的私域名單。
*   **營運影響**: 15 項獎品綁定園區各餐飲與設施櫃位，以 LINE User ID 天然防重複，把線上曝光精準導成現場消費。

### 11. [母親節抽抽樂：檔期行銷導客系統](./11-mothersday-lottery) (🌐 [線上展示](https://jojomondaylottery.web.app)) `檔期已結束`
